...
- **Cloud-Based Scalability:** Utilize Supabase for secure and scalable data storage and management.
...
- **Database (Supabase):** Stores criminal data securely in the cloud.
...
- **Database:** Supabase
- **Algorithms:** LBPH for face recognition.
...
I would like to thank my project guide, Mam Zareen Fatima
, for his constant support and guidance. I also extend my gratitude to the faculty members of the Department of Computer Science, my friends, and family for their encouragement and assistance throughout the project.
...
The project includes a full web app (Flask) that runs in the browser.

1. Install dependencies: `pip install -r requirements.txt`
2. Configure Supabase in `config.py` (URL, key, table name).
3. Run the web server:
   ```bash
   python app.py
   ```
4. Open a browser at **http://localhost:5000**
5. Log in (default account: `admin@1234` / `12345678`) or create an account.

**Web features:** Login/Signup, Dashboard, Register Criminal (multi-image upload), Scan Criminal (single image), Live CCTV (browser webcam → server-side recognition), Criminal profiles with photos.
